...
class HousingExeption(Exception):
    ...
    def get_detailed_error_message(error_message:Exception,error_detail:sys)->str:
        ...
        file_name = exec_tb.tb_frame.f_code.co_filename
        error_message = f"Error occured in script: [{file_name} at try block line number: [{try_block_line_number}] and exception block number:[{exception_block_line_number}] error message:[{error_message}]]"
        return error_message
